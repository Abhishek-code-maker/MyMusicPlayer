...
import com.abhishek.mymusicplayer.databinding.ActivityFeedbackBinding
import java.util.*
import javax.mail.*
...
class FeedbackActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.sendFeedbackFA.setOnClickListener {
            val feedbackMsg =
                binding.feedbackFA.text.toString() + "\n" + binding.emailFA.text.toString()
            val subject = binding.topicFA.text.toString()
            val userName = "music.worldapp19@gmail.com"
            val password = "abhi@7049"
