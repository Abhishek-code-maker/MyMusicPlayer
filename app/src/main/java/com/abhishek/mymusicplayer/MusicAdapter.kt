...
import com.abhishek.mymusicplayer.databinding.DetailsViewBinding
import com.abhishek.mymusicplayer.databinding.MoreFeaturesBinding
import com.abhishek.mymusicplayer.databinding.ViewMusicBinding
...
class MusicAdapter(
    ...
    class MyHolder(binding: ViewMusicBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolder {
        return MyHolder(ViewMusicBinding.inflate(LayoutInflater.from(context), parent, false))
    }
