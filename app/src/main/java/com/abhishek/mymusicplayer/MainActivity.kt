...
import com.abhishek.mymusicplayer.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    companion object{
        ...
        val currentTheme = arrayOf(R.style.coolBlue, R.style.coolPurple, R.style.coolOrange, R.style.coolRed, R.style.coolBlack)
        val currentThemeNav = arrayOf(R.style.coolBlueNav, R.style.coolPurpleNav, R.style.coolOrangeNav, R.style.coolRedNav, R.style.coolBlackNav)
        val currentGradient = arrayOf(R.drawable.gradient_blue, R.drawable.gradient_purple, R.drawable.gradient_orange, R.drawable.gradient_red, R.drawable.gradient_black)
        var sortOrder : Int = 0
...
//        navigation bar
        ...
        if(requestPermission()){
            initializeLayout()
            //        retrieving favourites data using sharedPreferences
...
//    Requesting Permission of storage
    ...
    private fun initializeLayout(){
        ...
        binding.recycle.setItemViewCacheSize(13)
    ...
    override fun onResume() {
        super.onResume()
        //        storing favourites data using sharedPreferences
